        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div className="items-center flex lg:order-2">
                    ...
                    text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none" to='/login'>
                        Log in
                    </Link>

                    <Link className="text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300
                    font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none" to='/signup'>
                        Get started
                    </Link>
                </div>
